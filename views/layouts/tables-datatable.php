                ...
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a href="tables-datatable.php" class="active">DataTable</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="section-description section-description-inline">
                                    ...
                                    <span>This example shows the DataTables table body scrolling in the vertical direction.</span>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                ...
                                <div class="section-description section-description-inline">
                                    ...
                                    <span>DataTables has the ability to show tables with horizontal scrolling.</span>
                                </div>
                                <div class="card">
                                    <div class="card-body">
