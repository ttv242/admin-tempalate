            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        <a href="calendar.php" class="active"><i class="material-icons-two-tone">calendar_today</i>Calendar<span class="badge rounded-pill badge-success float-end">14</span></a>
                    </li>
                    <li>
