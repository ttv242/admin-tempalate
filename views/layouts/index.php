<div class="app-container">
    <div class="search">
        ...
        <a href="index.php?action=#" class="toggle-search"><i class="material-icons">close</i></a>
    </div>
        ...
        <div class="content-wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card widget widget-list">
                            <div class="card-header">
                                <h5 class="card-title">Active Tasks<span
                                        class="badge badge-success badge-style-light">14 completed</span></h5>
                            </div>
                            <div class="card-body">
                                ...
                                <ul class="widget-list-content list-unstyled">
                                    <li class="widget-list-item widget-list-item-green">
                                        ...
                                        <span class="widget-list-item-description">
                                            <a href="index.php?action=#" class="widget-list-item-description-title">
                    ...
                    <div class="col-xl-4">
                        <div class="card widget widget-payment-request">
                            <div class="card-header">
                                <h5 class="card-title">Payment Request<span
                                        class="badge badge-warning badge-style-light">8 June</span></h5>
                            </div>
                            <div class="card-body">
                                <div class="widget-payment-request-container">
                                    ...
                                    <div class="widget-payment-request-product">
                                        <div class="widget-payment-request-product-image m-r-sm">
                                            <img src="views/assets/images/other/facebook_logo.png" class="mt-auto"
                                                alt="">
                                        </div>
                                    ...
                                    <div class="widget-payment-request-actions m-t-lg d-flex">
                                        <a href="index.php?action=#"
                                            class="btn btn-light flex-grow-1 m-r-xxs">Reject</a>
                                        <a href="index.php?action=#"
                                            class="btn btn-primary flex-grow-1 m-l-xxs">Approve</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="widget-popular-product-container">
                                    <div class="widget-popular-product-image">
                                        <img src="views/assets/images/widgets/popular-product.jpg" alt="">
                                    </div>
                                    <div class="widget-popular-product-tags">
                                        <span
                                            class="badge rounded-pill badge-secondary badge-style-light">Science</span>
                                        <span
                                            class="badge rounded-pill badge-success badge-style-light">Lifestyle</span>
                                        <span class="badge rounded-pill badge-danger badge-style-light">People</span>
                                    </div>
                                    <div class="widget-popular-product-content">
                                        <a href="index.php?action=#" class="widget-popular-product-title">Banana
                                            Donut</a>
                                        <p class="widget-popular-product-text m-b-md">Quisque congue risus sit amet
                                            ...
                                            dignissim nulla. Ut tincidunt tellus sit amet elit viverra porttitor.
                                            Mauris at tellus a nisl accumsan egestas suscipit..</p>
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card">
                            <img src="views/assets/images/widgets/blog5.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="widget-info-container">
                                    <div class="widget-info-image"
                                        style="background: url('http://polygons.space/neptune/source/assets/images/widgets/security.svg')">
                                    </div>
                                    ...
                                    <a href="index.php?action=#" class="btn btn-primary widget-info-action">Upgrade
                                        Now</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-8">
                        <div class="card widget widget-popular-blog">
                            <div class="card-body">
                                <div class="widget-popular-blog-container">
                                    <div class="widget-popular-blog-image">
                                        <img src="views/assets/images/widgets/product2.jpg" alt="">
                                    </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="index.php?action=#" class="btn btn-primary float-end">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="card widget widget-connection-request">
                            ...
                            <div class="card-body">
                                ...
                                <div class="widget-connection-request-actions d-flex">
                                    <a href="index.php?action=#"
                                        class="btn btn-primary btn-style-light flex-grow-1 m-r-xxs"><i
                                            class="material-icons">done</i>Accept</a>
                                    <a href="index.php?action=#"
                                        class="btn btn-danger btn-style-light flex-grow-1 m-l-xxs"><i
