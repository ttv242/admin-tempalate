                ...
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a href="styles-code.php" class="active">Code</a>
                            </li>
                            <li>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item hidden-on-mobile">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end language-dropdown"
                                ...
                                <li><a class="dropdown-item" href="#"><img src="views/assets/images/flags/germany.png"
                                            alt="">German</a></li>
                ...
                <div class="row">
                    <div class="col">
                        <div class="page-description">
                            <h1>Code</h1>
                            <span>Documentation and examples for displaying inline and multiline blocks of code with
                                Bootstrap.</span>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-description">Wrap inline snippets of code with <code>&lt;code&gt;</code>.
                                    Be sure to escape HTML angle brackets.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-description">For indicating variables use the <code>&lt;var&gt;</code>
                                    tag.</p>
                                <div class="example-container">
                                    <div class="example-content">
                                    ...
                                    <div class="example-code">
                                        <pre><code class="html">&lt;var&gt;y&lt;/var&gt; = &lt;var&gt;m&lt;/var&gt;&lt;var&gt;x&lt;/var&gt; + &lt;var&gt;b&lt;/var&gt;</code></pre>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-description">For indicating sample output from a program use the
                                    <code>&lt;samp&gt;</code> tag.</p>
                                <div class="example-container">
                                    <div class="example-content">
                                    ...
                                    <div class="example-code">
                                        <pre><code class="html">&lt;samp&gt;This text is meant to be treated as sample output from a computer program.&lt;/samp&gt;</code></pre>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-description">Use <code>&lt;pre&gt;</code>s for multiple lines of code.
                                    Once again, be sure to escape any angle brackets in the code for proper rendering.
                                    You may optionally add the <code>.pre-scrollable</code> class, which will set a
                                    max-height of 340px and provide a y-axis scrollbar.</p>
                                <div class="example-container">
                                    <div class="example-content">
...
&lt;/code&gt;&lt;/pre&gt;</code></pre>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-description">Use the <code>&lt;kbd&gt;</code> to indicate input that is
                                    typically entered via keyboard.</p>
                                <div class="example-container">
                                    <div class="example-content">
                                        To switch directories, type <kbd>cd</kbd> followed by the name of the
                                        directory.<br>To edit settings, press <kbd><kbd>ctrl</kbd> + <kbd>,</kbd></kbd>
                                    </div>
                                    <div class="example-code">
                                        <pre><code class="html">To switch directories, type &lt;kbd&gt;cd&lt;/kbd&gt; followed by the name of the directory.&lt;br&gt;
