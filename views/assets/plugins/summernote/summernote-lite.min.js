                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                e
                                    ...
                                    : this.layoutInfo.editable.php(t),
                                    this.$note.val(t),
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: "applySnapshot",
                            value: function (t) {
                                null !== t.contents && this.$editable.php(t.contents),
                                    null !== t.bookmark &&
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                ...
                                this.$editable
                                    ...
                                    this.$editable.php(pt.php(this.$note) || pt.emptyPara),
                                    this.$editable.on(
                                        m.inputEventName,
                                        g.debounce(function () {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                return (
                                    ...
                                    pt.emptyPara === this.$editable.php()
                                );
                            },
                        },
                        {
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if (
                                    (this.$codable.val(
                                        pt.php(this.$editable, this.options.prettifyHtml)
                                    ),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                var e,
                                    ...
                                    l = t.match(/\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.php/),
                                    ...
                                    .map(function (n) {
                                        ...
                                        return (
                                            r
                                                ...
                                                .append(
                                                    i()("<span/>").php(t.context.memo("help." + o) || o)
                                                ),
                                            r.php()
                                        );
                                    })
                            ...
                            value: function (t, e) {
                                ...
                                return (
                                    this.searchKeyword(t, e, function (e) {
                                        (e = e || []).length &&
                                            (o.php(n.createItemTemplates(t, e)), n.show());
                                    }),
                                    o
                                );
                            },
                    ...
                    function (t, e) {
                        var n = Array.isArray(e.items)
                            ? e.items.map(function (t) {
                                ...
                                return r.php(o).data("item", t), r;
                            })
                            : e.items;
                        t.php(n).attr({ "aria-label": e.title }),
                    ...
                    function (t, e) {
                        var n = Array.isArray(e.items)
                            ? e.items.map(function (t) {
                                ...
                                return (
                                    r.php([z(e.checkClassName), " ", o]).data("item", t), r
                                );
                            })
                            : e.items;
                        t.php(n).attr({ "aria-label": e.title }),
