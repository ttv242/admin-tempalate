  ...
  function e(e) {
    function o(o, i) {
      ...
      if (
        ...
        (g =
          ...
          (w = e(U)),
          v &&
            (i.theme ? (w.css(h), w.addClass("ui-widget-content")) : w.css(s)),
        ...
        var O =
          f &&
          (!e.support.boxModel || e("object,embed", k ? null : o).length > 0);
        if (u || O) {
          if (
            (k &&
              i.allowBodyStretch &&
        ...
        if (
          (v &&
            (i.theme ? w.find(".ui-widget-content").append(v) : w.append(v),
        ...
        if (
          ...
          k
            ? ((b = w[0]),
              ...
              i.focusInput && setTimeout(l, 20))
            : a(w[0], i.centerX, i.centerY),
          i.timeout)
        ) {
    ...
    function t(o, t) {
      ...
      c && (clearTimeout(c), a.removeData("blockUI.timeout")),
        ...
        n(0, o, t),
        null === t.onUnblock &&
          ((t.onUnblock = a.data("blockUI.onUnblock")),
      ...
      (r = l
        ...
        : a.find(">.blockUI")),
        t.cursorReset &&
          (r.length > 1 && (r[1].style.cursor = t.cursorReset),
    ...
    function n(o, t, i) {
      var n = t == window,
        l = e(t);
      if (
        (o || ((!n || b) && (n || l.data("blockUI.isBlocked")))) &&
        (l.data("blockUI.isBlocked", o),
    ...
    function s(o) {
      ...
      var s = o.data,
        a = e(o.target);
      return (
        a.hasClass("blockOverlay") && s.onOverlayClick && s.onOverlayClick(o),
    ...
    (e.blockUI = function (e) {
      ...
      (e.fn.block = function (t) {
        ...
        return (
          this.each(function () {
            var o = e(this);
            (i.ignoreIfBlocked && o.data("blockUI.isBlocked")) ||
              o.unblock({ fadeOut: 0 });
          }),
          this.each(function () {
